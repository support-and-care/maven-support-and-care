...
* Start working on JPMS support ([#49](https://github.com/support-and-care/maven-support-and-care/issues/49)):
  * Analyzing the current situation of JPMS wrt. Maven [#134](https://github.com/support-and-care/maven-support-and-care/issues/134))
  * Fixing issue in (MojoHaus) Maven Exec Plugin ([#138](https://github.com/support-and-care/maven-support-and-care/issues/138))
  * Create Showcases for JPMS ([#137](https://github.com/support-and-care/maven-support-and-care/issues/137))
* We continued refactoring of the Maven Surefire plugin to use only junit-platform-engine to run tests. ([#51](https://github.com/support-and-care/maven-support-and-care/issues/51))

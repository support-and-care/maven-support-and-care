...
The current Maven Surefire/Failsafe plugin architecture maintains separate test providers for JUnit 3, JUnit 4, JUnit 5/Jupiter, and TestNG, creating maintenance complexity with 5 different
...
The major refactoring work in PR #3179 (https://github.com/apache/maven-surefire/pull/3179) has consolidated all test execution under the JUnit Platform infrastructure:
 ...
 - Completed: Minimum JUnit 4 version enforced to 4.12; older versions no longer supported
 - Completed: JUnit 4 tests now execute via JUnit Platform + Vintage engine instead of separate provider
 - Completed: TestNG integration migrated to run under JUnit Platform with proper group/tag mappings
 - Completed: Minimum TestNG version set to 6.14.3
...
## Expected Outcomes / Benefits
 ...
 - Single Implementation: Reduced maintenance burden from 5 test providers down to 1 JUnit Platform-based runner, making feature additions and bug fixes significantly easier
